...
namespace Project2WooxTravel.Areas.Admin.Controllers
{
    public class DestinationController : Controller
    {
        ...
        [HttpPost] // eğer bir metodda  herhangi bir attribute verilmezse başlangıçta default attribute ne diye kabul ediliyordu ? (get) , eğer metodda attribute belirtmezsem o gettir. ve yazmama gerek kalmıyor.
        public ActionResult CreateDestination(Destination destination)
        {
            context.Destinations.Add(destination);
            context.SaveChanges();
            return RedirectToAction("DestinationList", "Destination","Admin"); //metad control area ismi sırasıyla yazdık.
        }
